...
| [说人话.md](working-with-me/说人话.md) | 所有输出文字的底线。核心是三个成分：想清楚了、人在场、说给对方听 |
...
最该先读的是 `说人话.md`。它解决的是一个具体问题：**AI 写出来的东西看着头头是道，人读起来却别扭。** 我的诊断不是"用词太正式"，是叙述者从事情里跑出去了——不敢下判断、不敢担责任，于是抽象词、套话、省主语全都冒出来填空。所以它不是一份禁用词清单（清单永远追不上新的套话），是三个成分和三个可执行的检查。

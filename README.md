...
`working-with-me/`，七份文档：

| 文档 | 管什么 |
|---|---|
| [SKILL.md](working-with-me/SKILL.md) | 主文。五件最要紧的事：开口前先想我现在要什么、只凭"开工"动手、收不回来的事先问、同一个错不犯第二次、从零开始不打补丁 |
| [说人话.md](working-with-me/说人话.md) | 所有输出文字的底线。核心是四件事：事情、关系、责任、读者 |
| [写文章.md](working-with-me/写文章.md) | 写有人有事的文章：写人、意象、不替读者宣布感受、模仿一个人的口气 |
...
最该先读的是 `说人话.md`。它解决的是一个具体问题：**AI 写出来的东西看着头头是道，人读起来却别扭。** 我的诊断不是"用词太正式"，是叙述者从事情里跑出去了——不敢下判断、不敢担责任，于是抽象词、套话、省主语全都冒出来填空。所以它不是一份禁用词清单（清单永远追不上新的套话），是四件事和五遍可执行的检查。写文章、写人、模仿一个人的口气，在 `写文章.md` 里。
...
Fork 之后要改的地方：`atypica.md` 换成你自己的项目；其余六份里那些"他"就是你，把不像你的地方改掉。文档里的例子可以留着当参照——它们是形状的示范，不是内容的规定。
